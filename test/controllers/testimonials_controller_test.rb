...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { client_name: @testimonial.client_name, description: @testimonial.description, launched_on: @testimonial.launched_on, name: @testimonial.name, slug: @testimonial.slug, url: @testimonial.url }
    end
  ...
  test "should update testimonial" do
    patch :update, id: @testimonial, testimonial: { client_name: @testimonial.client_name, description: @testimonial.description, launched_on: @testimonial.launched_on, name: @testimonial.name, slug: @testimonial.slug, url: @testimonial.url }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
