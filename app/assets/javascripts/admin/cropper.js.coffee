class @Cropper
  constructor: ($container) ->
    ...
    @resizeable = @inputs.resizeWidth.length > 0 && @inputs.resizeHeight.length > 0
    @applyImageEvents()
