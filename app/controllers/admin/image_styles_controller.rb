class Admin::ImageStylesController < Admin::ApplicationController
  ...
  def new
    ...
    respond_with :admin, @image_style.becomes(Image::Style), template: 'admin/image_styles/editor'
  end
  ...
  def create
    ...
    respond_with :admin, @image_style.becomes(Image::Style), location: [:admin, @image], template: 'admin/image_styles/editor'
  end
